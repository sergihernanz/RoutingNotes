...
private class _AnyNavigationEndpointsBuilderBase<NavigationType: Navigation, NavigatorType: Navigator, ModelType>: NavigationEndpointsBuilder {
...
fileprivate final class _AnyNavigationEndpointsBuilderBox<Concrete: NavigationEndpointsBuilder>:
...
final class AnyNavigationEndpointsBuilder<NavigationType: Navigation, NavigatorType: Navigator, ModelType>: NavigationEndpointsBuilder {
    ...
    init<Concrete: NavigationEndpointsBuilder>(_ concrete: Concrete) where Concrete.NavigationType == NavigationType,
